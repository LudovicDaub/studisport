...
class StructureController extends AbstractController
{
    ...
    public function index(Request $request, PartnerRepository $partnerRepository, StructureRepository $structureRepository, PermissionRepository $permissionRepository, ManagerRegistry $doctrine): Response
    {
        ...
        $partnerPermissions = $doctrine->getRepository(Permission::class)->find($permPartnerId);
        ...
        $userPermissions = $doctrine->getRepository(Permission::class)->find($permId);
    ...
    public function edit(int $id, Request $request, StructureRepository $structureRepository, ManagerRegistry $doctrine, EntityManagerInterface $em): Response
    {
