    ...
    public function index(Request $request): Response
    {
        ...
        if ($request->get('email')) {
            ...
            if ($user) {
                ...
                $content = "Bonjour " . $user->getName() . "<br/>Vous avez demandé à réinitialiser votre mot de passe sur le site STUDI SPORT.<br/><br/>";
                $content .= "Merci de bien vouloir cliquer sur le lien suivant pour " . $url . " mettre à jour votre mot de passe.";

                $mail = new Mail();
                $mail->send($user->getEmail(), $user->getName(), 'Réinitialiser votre mot de passe STUDI SPORT', $content);
